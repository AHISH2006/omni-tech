                    ...
                    >
                        ...
                        <div className="description-box">
                            <p className="event-description">
                                <strong>MISSION BRIEF:</strong> <br />
                                Engage in the {event.title} challenge. This non-technical event is designed to test your situational awareness, creativity, and strategic thinking.
                                <br /><br />
                                Prepare yourself for an immersive experience where only the most versatile participants will triumph.
                            </p>
                        </div>
